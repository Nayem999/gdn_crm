...
test('the catalogue covers the modules built so far', function () {
    expect(array_keys(PermissionCatalogue::groups()))
        ->toEqualCanonicalizing(['company', 'users', 'teams', 'roles', 'accounts', 'leads', 'contacts', 'deals', 'activities', 'custom-fields', 'custom-modules', 'saved-views', 'products', 'quotes', 'orders', 'workflows', 'timeline', 'settings', 'notifications', 'audit']);
});
